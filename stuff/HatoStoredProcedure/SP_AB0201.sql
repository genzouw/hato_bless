...
/****** Object:  StoredProcedure [dbo].[SP_AB0201]    Script Date: 07/31/2014 11:41:32 ******/
SET ANSI_NULLS ON
GO
...
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/28 10:58:14 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/28 10:45:42 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/28 10:32:11 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/24 11:08:00 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/24 10:50:03 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/24 9:33:31 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/21 21:17:20 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/21 20:15:38 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/21 20:07:50 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/21 18:00:12 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/21 14:56:42 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/21 14:23:47 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/21 12:45:23 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.SP_AB0201    スクリプト日付 : 2005/02/18 15:02:08 ******/
CREATE                      PROCEDURE [dbo].[SP_AB0201]
...
BEGIN
	...
	DECLARE AB0201_CUR00 CURSOR FOR 
	...
	OPEN AB0201_CUR00
	FETCH  NEXT FROM AB0201_CUR00 INTO
		@依頼組織CD,
		@受付番号,
		@顧客名,
		@法人CD,
	...
	BEGIN
		...
		DELETE FROM W_HIKKOSHI_CSV_NORMAL WHERE IRAI_SOSHIKI_CD = @依頼組織CD
/******* Added 2005.03.09 Akihisa Urushibara *******/
		SET @ERROR = @@ERROR
		IF @ERROR > 0
		BEGIN
...
/******* Added 2005.03.09 Akihisa Urushibara *******/
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					INSERT INTO W_HIKKOSHI_CSV_NORMAL
					(
						IRAI_SOSHIKI_CD,
						UKETSUKE_NO,
						SOSHIKI_CD
...
--		EXEC SP_AB0202 @依頼組織CD	-- 受注基本、受注詳細
--		EXEC SP_AB0203 @依頼組織CD	-- 業務情報
--		EXEC SP_AB0204 @依頼組織CD	-- 料金明細
		EXEC SP_AB0202 @依頼組織CD, @ERROR OUTPUT	-- 受注基本、受注詳細
		IF @ERROR > 0
		BEGIN
			GOTO __TIDY_UP_PROC
		END

		EXEC SP_AB0203 @依頼組織CD, @ERROR OUTPUT	-- 業務情報
		IF @ERROR > 0
		BEGIN
			GOTO __TIDY_UP_PROC
		END

		EXEC SP_AB0204 @依頼組織CD, @ERROR OUTPUT	-- 料金明細
		IF @ERROR > 0
		BEGIN
			GOTO __TIDY_UP_PROC
		END
...
/******* Added 2005.03.09 Akihisa Urushibara *******/
		...
		END
/******* Added 2005.03.09 Akihisa Urushibara *******/
		INSERT INTO T_JUCHU_CSV_STATUS VALUES (@依頼組織CD,'WWW1','1','0','','BATCH','BATCH','0')
/******* Added 2005.03.09 Akihisa Urushibara *******/
		SET @ERROR = @@ERROR
		IF @ERROR > 0
		BEGIN
		...
		END
/******* Added 2005.03.09 Akihisa Urushibara *******/
		INSERT INTO T_JUCHU_CSV_STATUS VALUES (@依頼組織CD,'WWW2','1','0','','BATCH','BATCH','0')
/******* Added 2005.03.09 Akihisa Urushibara *******/
		SET @ERROR = @@ERROR
		IF @ERROR > 0
		BEGIN
		...
		END
/******* Added 2005.03.09 Akihisa Urushibara *******/
		INSERT INTO T_JUCHU_CSV_STATUS VALUES (@依頼組織CD,'WWW3','1','0','','BATCH','BATCH','0')
/******* Added 2005.03.09 Akihisa Urushibara *******/
		SET @ERROR = @@ERROR
		IF @ERROR > 0
		BEGIN
...
__TIDY_UP_PROC:
	IF @ERROR > 0
	BEGIN
		EXEC RECORD_SP_ERROR 'SP_AB0201', @依頼組織CD, @ERROR
	END
/******* Added 2005.03.09 Akihisa Urushibara *******/
	CLOSE AB0201_CUR00
	DEALLOCATE AB0201_CUR00
END
