...
/****** Object:  StoredProcedure [dbo].[EB0090]    Script Date: 07/31/2014 11:33:44 ******/
SET ANSI_NULLS ON
GO
...
/****** オブジェクト :  ストアド プロシージャ dbo.EB0090    スクリプト日付 : 2004/07/13 22:01:35 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.EB0090    スクリプト日付 : 2004/07/12 11:26:13 ******/
/**********************/
/* 請求データ作成処理 */
/**********************/
CREATE PROCEDURE [dbo].[EB0090]
As
	-- トランザクション --
	Begin Transaction
    -- カウンタ停止 --
