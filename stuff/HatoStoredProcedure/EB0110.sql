...
/****** Object:  StoredProcedure [dbo].[EB0110]    Script Date: 07/31/2014 11:34:32 ******/
SET ANSI_NULLS ON
GO
...
/****** オブジェクト :  ストアド プロシージャ dbo.EB0110    スクリプト日付 : 2004/07/13 22:01:35 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.EB0110    スクリプト日付 : 2004/07/12 11:26:13 ******/
/**********************/
/* 請求データ精算確定作成処理 */
/**********************/
CREATE PROCEDURE [dbo].[EB0110]
AS
	...
	-- 020728 ukita
    delete T_SEISAN_KAKUTEI WHERE SEIKYU_SIHARAI_CD = '1' AND MEISAI_KBN = '2' AND SEIKYU_YM = @清算月
    -- ローカルカーソルを開く
    Open My_cur
    -- 結果セットの行数を取得する
