            ...
            <div class="messageArea wordBreak" style="padding:40px;">
                ...
                <div id="page1" class="tabBox">
                    <div id="note_title" style="border-left: 2px solid #72936F;padding-left:20px;margin-bottom:15px;">
                        ...
                        <div class="note_user">
                            <div style="font-weight:bold;float:left;width:70px;">作成者</div>
                            : <?php echo h($note['User']['NAME']); ?></div>
                        <?php if ($isMyNote) { ?>
                            <div>
                                <div style="font-weight:bold;float:left;width:70px;">公開範囲</div>
                                : <?php echo h($public[$note['Note']['PUBLIC']]); ?></div>
                            <div style="float:left;margin-bottom:10px;">
                                <div style="font-weight:bold;float:left;width:70px;">ステータス</div>
                                : <?php echo h($status[$note['Note']['STATUS']]); ?></div>
                    ...
                    <iframe id="note_content" name="note_contetnt_frame" frameborder="0"
                            style="font:12px;border: 1px #CCCCCC solid;" scrolling=”no”
                            src="<?php echo $html->url(array('plugin' => 'note', 'controller' => 'note', 'action' => 'renderNoteContent', 'noteID' => $note['Note']['NOTE_ID']), true); ?>">
