...
<div id="popup_wrap">
    <div id="TB_title">
        ...
        <div id="TB_closeAjaxWindow">
            <a id="TB_closeWindowButton" title="Close" href="javascript:void(0)" onClick="popupclass.popup_close();"
               style='color:#fff;'>閉じる</a>
        </div>
    </div>
    <div id="popup_upload">
        ...
        <div class='indexlists'>
            <table>
                <tr>
                    <th>ファイル</th>
                    <td><?php echo $form->file('Storage.FILE', array('class' => 'filess')); ?>
                        <div id="result" class="errors"></span></div>
                </tr>
            </table>
