...
class AppMachaController extends Controller
{
    var $ext = '.html';
    public $user = array();
...
//        'Macha.Common',
    ...
    {
        $this->user['User']['USR_ID'] = null;
        $this->user['User']['GRP_ID'] = null;
        $this->user['User']['NAME'] = null;
        $this->user['User']['AUTHORITY'] = null;

        $this->set("searchList", null);
        $this->set("message", null);
        $this->set("request", null);
        $this->set("invite_conf", null);
        $this->set("grpid", null);
