...
/****** Object:  StoredProcedure [dbo].[EB0140]    Script Date: 07/31/2014 11:35:04 ******/
SET ANSI_NULLS ON
GO
...
/****** オブジェクト :  ストアド プロシージャ dbo.EB0140    スクリプト日付 : 2004/07/13 22:01:35 ******/
/****** オブジェクト :  ストアド プロシージャ dbo.EB0140    スクリプト日付 : 2004/07/12 11:26:12 ******/
/**********************/
/* 請求データ精算確定作成処理 */
/**********************/
CREATE PROCEDURE [dbo].[EB0140]
AS
	...
	-- 20040728 ukita
	delete T_SEISAN_MEISAI WHERE SEIKYU_SIHARAI_CD = '2' AND MEISAI_KBN = '2' AND SEIKYU_YM = @清算月 AND KAKUTEI_KESHI_KBN = '0' 
    -- ローカルカーソルを開く
    Open My_cur
    -- 結果セットの行数を取得する
