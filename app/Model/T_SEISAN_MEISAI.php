<?php
class T_SEISAN_MEISAI extends AppModel {

    public $useTable = 'T_SEISAN_MEISAI';
    public $primaryKey = array('ID','SEIKYU_YM','MOTO_SOSHIKI_CD','SAKI_SOSHIKI_CD','SEIKYU_SIHARAI_CD','MEISAI_KBN','HIYOKOMOKU_CD','KANRI_NO','SEIKYU_GK_KBN');

    /*
    CREATE TABLE [dbo].[T_SEISAN_MEISAI](
        ...
        [KANRI_NO] [char](8) NOT NULL,
        [CREDITCARD_CD] [char](2) NULL,
        [KOKYAKUMEI] [varchar](16) NULL,
        [KAKUTEI_KESHI_KBN] [char](1) NULL,
        [SEIKYU_GK_KBN] [char](1) NOT NULL,
        [UPDATE_DT] [char](17) NULL,
        [UPDATE_TNT_ID] [char](10) NULL,
        [GAMEN_ID] [char](6) NULL,
        [DELETE_FLG] [char](1) NOT NULL CONSTRAINT [DF_T_SEISAN_MEISAI_DELETE_FLG]  DEFAULT ('0'),
     CONSTRAINT [PK_T_SEISAN_MEISAI] PRIMARY KEY CLUSTERED
    (
        [SEIKYU_YM] ASC,
        [MOTO_SOSHIKI_CD] ASC,
        [SAKI_SOSHIKI_CD] ASC,
    ...
    */
     ...
     */
    function del($data){
        $data['T_SEISAN_MEISAI']['id'] = $data['target_id'];
        $data['T_SEISAN_MEISAI']['del_flg'] = 1;
        return $this->save($data);
    ...
    function getAddEntity(){
        ...
        $arrRes['T_SEISAN_MEISAI']['ID'] = null;
        foreach ( $array as $key => $value ) {
            $arrRes['T_SEISAN_MEISAI'][$key] = null;
        }
        return $arrRes;
    ...
    function getPagingEntity($disp_num,$pgnum){
        ...
        $sql =  "";
        $sql .=  "     SELECT * ";
        $sql .=  "       FROM T_SEISAN_MEISAI ";
        $sql .=  "      WHERE T_SEISAN_MEISAI.DELETE_FLG = 0 ";
        /*
        ...
        */
        $order =  " ORDER BY T_SEISAN_MEISAI.UPDATE_DT DESC ";
