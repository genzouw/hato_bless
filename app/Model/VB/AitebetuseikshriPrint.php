<?php
class AitebetuseikshriPrint extends AppModel {

    public $useTable = false;
//    public $primaryKey = array('ID','SEIKYU_YM','MOTO_SOSHIKI_CD','SAKI_SOSHIKI_CD','SEIKYU_SIHARAI_CD','HIYOKOMOKU_CD');

/*
        Public Shared entBusiness As UserKanri

        Private DAL As GsolDAL
        ...
        Public Function UpdateUserKanri(objEntity As Object, MsgCd As String) As Boolean
            ...
            Try
                ...
                If flag Then
                    result = False
                Else
                    sqlCommand = String.Format(masterSQL.IMF0030().ToString(), New Object()() { userKanri.STR_USER_ID, userKanri.STR_PASSWORD, userKanri.STR_SECURITY_CD, userKanri.STR_SOSHIKI_CD, userKanri.STR_LOGIN_MEI, userKanri.STR_TANTOSHA_CD, userKanri.STR_UPDATE_DT, userKanri.STR_GAMEN_ID, userKanri.STR_UPDATE_TNT_ID })
