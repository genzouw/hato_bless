<?php
class SeikyuList extends AppModel {

    public $useTable = false;
//    public $primaryKey = array('ID','SEIKYU_YM','MOTO_SOSHIKI_CD','SAKI_SOSHIKI_CD','SEIKYU_SIHARAI_CD','HIYOKOMOKU_CD');

    function getSeikyuJyoho(){

    /*
        Public Function GetSeikyuJyoho(objEntity As Object(), ByRef MsgCd As String, FindFlg As String) As SeikyuList()
