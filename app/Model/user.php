 ...
 *
 */
class User extends AppMachaModel
{
     ...
     * @param array $_data
     * @param string $_auth
     * @param bool|string $_mail
     * @param bool|string $_rec
     * @param bool|string $_approval
     * @return boolean
     * @access public
     * @author 作成者
     */
